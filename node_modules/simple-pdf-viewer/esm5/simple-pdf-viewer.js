...
var SimplePDFBookmark = /** @class */ (function () {
    ...
    SimplePDFBookmark.buildSimplePDFBookmark = function (src) {
        if (src && typeof src === 'string' && src.trim().length > 0) {
            ...
            if (parts.length > 0) {
                var /** @type {?} */ bookmark_1 = new SimplePDFBookmark();
                parts.forEach(function (part) {
                    var /** @type {?} */ parameters = part.split("=");
                    var /** @type {?} */ paramert_name = parameters[0];
                    if (parameters.length === 2 && bookmark_1.hasOwnProperty(paramert_name)) {
                        var /** @type {?} */ paramert_value = 0;
...
var SimplePdfViewerComponent = /** @class */ (function () {
    ...
    SimplePdfViewerComponent.prototype.ngOnInit = function () {
        if (typeof window !== 'undefined') {
            if (typeof PDFJS.workerSrc !== 'string') {
                var /** @type {?} */ workerUrl = "https://cdnjs.cloudflare.com/ajax/libs/pdf.js/" + (((PDFJS))).version + "/pdf.worker.min.js";
    ...
    SimplePdfViewerComponent.prototype.initPDFJS = function () {
        var /** @type {?} */ container = this.getContainer();
    ...
    SimplePdfViewerComponent.prototype.setAndParseSrc = function (src) {
        ...
        if (this.src && typeof this.src === 'string') {
            var /** @type {?} */ parts = this.src.split(SimplePDFBookmark.PARAMETER_SEPARATOR);
            if (parts.length > 1) {
    ...
    SimplePdfViewerComponent.prototype.zoomFullPage = function () {
        ...
        if (this.isDocumentLoaded()) {
            this.pdf.getPage(this.currentPage).then(function (page) {
                var /** @type {?} */ scale = _this.getScale(page, ScalePriority.FULL);
                _this.setZoom(scale);
            });
        }
    };
    ...
    SimplePdfViewerComponent.prototype.zoomPageWidth = function () {
        ...
        if (this.isDocumentLoaded()) {
            this.pdf.getPage(this.currentPage).then(function (page) {
                var /** @type {?} */ scale = _this.getScale(page, ScalePriority.WIDTH);
                _this.setZoom(scale);
            });
        }
    };
    ...
    SimplePdfViewerComponent.prototype.zoomPageHeight = function () {
        ...
        if (this.isDocumentLoaded()) {
            this.pdf.getPage(this.currentPage).then(function (page) {
                var /** @type {?} */ scale = _this.getScale(page, ScalePriority.HEIGHT);
                _this.setZoom(scale);
            });
        }
    };
    ...
    SimplePdfViewerComponent.prototype.getScale = function (page, priority) {
        ...
        var /** @type {?} */ viewport = page.getViewport(1, this.rotation);
        var /** @type {?} */ offsetHeight = this.getContainer().offsetHeight;
        var /** @type {?} */ offsetWidth = this.getContainer().offsetWidth;
        if (offsetHeight === 0 || offsetWidth === 0) {
            return 1;
        }
        var /** @type {?} */ heightRatio = (offsetHeight - SimplePdfViewerComponent.PAGE_RESIZE_BORDER_HEIGHT) / viewport.height;
        var /** @type {?} */ widthRatio = (offsetWidth - SimplePdfViewerComponent.PAGE_RESIZE_BORDER_WIDTH) / viewport.width;
        var /** @type {?} */ ratio = heightRatio < widthRatio ? heightRatio : widthRatio;
    ...
    SimplePdfViewerComponent.prototype.setZoom = function (scale) {
        if (this.isDocumentLoaded() && typeof scale === 'number') {
            var /** @type {?} */ normalizedScale = this.normalizeScale(scale);
    ...
    SimplePdfViewerComponent.prototype.normalizeScale = function (scale) {
        var /** @type {?} */ normalizedScale = Math.round(scale * 1000) / 1000;
    ...
    SimplePdfViewerComponent.prototype.search = function (text, searchOptions) {
        ...
        if (this.isDocumentLoaded()) {
            var /** @type {?} */ searchText = text ? text.trim() : '';
            if (!searchText) {
                return;
            }
    ...
    SimplePdfViewerComponent.prototype.navigateToPage = function (page, pageDefault) {
        if (this.isDocumentLoaded()) {
            var /** @type {?} */ pageInt = parseInt("" + page, 10);
    ...
    SimplePdfViewerComponent.prototype.createBookmark = function () {
        ...
        var /** @type {?} */ pagePromise = ((this.pdf.getPage(this.currentPage)));
        return pagePromise.then(function (page) {
            var /** @type {?} */ viewport = page.getViewport(1, _this.rotation);
            var /** @type {?} */ container = _this.getContainer();
            var /** @type {?} */ x = container.scrollLeft / container.scrollWidth * viewport.width;
            var /** @type {?} */ y = (container.scrollHeight - container.scrollTop) / container.scrollHeight * viewport.height;
    ...
    SimplePdfViewerComponent.prototype.getPageSnapshot = function (scale) {
        ...
        if (this.isDocumentLoaded()) {
            var /** @type {?} */ pagePromise = ((this.pdf.getPage(this.currentPage)));
            return pagePromise.then(function (page) {
                var /** @type {?} */ viewport = page.getViewport(scale, 0);
                var /** @type {?} */ canvas = ((document.createElement('canvas')));
                var /** @type {?} */ context = canvas.getContext('2d');
                canvas.height = viewport.height;
                canvas.width = viewport.width;
                var /** @type {?} */ task = ((page.render({ canvasContext: context, viewport: viewport })));
    ...
    SimplePdfViewerComponent.prototype.dataURItoFile = function (dataURI) {
        ...
        var /** @type {?} */ mimeString = dataURI.split(',')[0].split(':')[1].split(';')[0];
        var /** @type {?} */ ia = new Uint8Array(byteString.length);
        for (var /** @type {?} */ i = 0; i < byteString.length; i++) {
            ia[i] = byteString.charCodeAt(i);
        }
        var /** @type {?} */ blob = new Blob([ia], { type: mimeString });
        var /** @type {?} */ b = blob;
...
/** @nocollapse */
SimplePdfViewerModule.ctorParameters = function () { return []; };
/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes} checked by tsc
 */
